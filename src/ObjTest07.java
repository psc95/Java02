/* 생성자가 오버로딩이 되면 자바 컴파일로는 매개변수가 없는 기본생성자(디폴트 생성자)를 더이상 묵시적으로 
 * 제공하지 않는다.
 */
class Member07{
...
public class ObjTest07 {
	public static void main(String[] args) {
       Member07 member=new Member07();//묵시적으로 제공되지 않는 기본생성자를 호출할려다가 에러가 발생
       member.print_Member();
       
       Member07 member2=new Member07("abc56789","77777","세종대왕님");//전달인자 3개자리 오버로딩 된 생성
       //자 호출
