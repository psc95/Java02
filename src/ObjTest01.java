...
/* add()메서드 첫번째,두번째 매개변수 자료형은 기본타입이어서 값이 전달되고,세번째 매개변수는 배열즉 참조타입이라서 배열주소
 * 가 전달되어서 배열주소가 공유되기 때문에 값을 공유할 수 있다.*/
class MtObj01{
	int add(int a,int b) {
		return a+b;
	}
...
public class ObjTest01 {
	public static void main(String[] args) {
      ...
      System.out.println("result2[0]="+result2[0]);//8=>배열주소값을 공유해서 8이 됨.
	}
}
